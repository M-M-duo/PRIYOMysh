...
private:
    ...
    void sendAuthRequest(const QString &nickname, const QString &login, const QString &password, const QString &email, const QString &phone, bool isPublic, const QString &mode);
