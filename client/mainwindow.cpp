...
MainWindow::MainWindow(QWidget *parent)
  ...
  if (!logoPixmap.isNull()) {
    QPixmap scaledLogo = logoPixmap.scaled(360, 360, Qt::KeepAspectRatio,
  ...
  connect(loginBtn, &QPushButton::clicked, [this]() {
    ...
    connect(dialog, &AuthDialog::loginClicked, this,
  ...
  connect(registerBtn, &QPushButton::clicked, [this]() {
    ...
    currentDialog = dialog;
    connect(dialog, &AuthDialog::registerClicked, this,
...
void MainWindow::onRegisterClicked(const QString &login,
...
void MainWindow::sendSignInRequest(const QString &login,
                                   const QString &password) {
